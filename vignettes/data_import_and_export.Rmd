...
The columns `sample_id` (sample ID), `injection.order` (injection order), `class` (Blank, QC, Subject, etc), `group` (case, control, etc) are required.
...
Then we can create `mass_data` class object
